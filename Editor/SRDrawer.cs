...
[CustomPropertyDrawer(typeof(SRAttribute), true)]
public class SRDrawer : PropertyDrawer
{
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		...
		if (EditorGUI.DropdownButton(popupPosition, typeNameContent, FocusType.Passive))
		{
		...
		//EditorGUI.MultiPropertyField(position, content, property, label);
	...
	private void ShowMenu(SerializedProperty property, bool applyArray)
	{
		...
		if (types != null)
		{
			...
			{
				context.AddItem(new GUIContent(types[i].Path.Replace('.', '/')), false, OnMenuItemClick, new SRAction(property, types[i].Path));
			}
		}
